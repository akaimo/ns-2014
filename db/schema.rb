...
ActiveRecord::Schema.define(:version => 20141212031338) do
  ...
  add_index "details", ["tour_infomation_id"], :name => "index_details_on_tour_infomation_id"
  ...
  add_index "reviews", ["tour_infomation_id"], :name => "index_reviews_on_tour_infomation_id"

  create_table "tour_infomations", :force => true do |t|
